    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form class="needs-validation" method="POST" action="{{ route('backend.header.update',1) }}"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="phone_title" type="text"
                                            value="{{ $header?->phone_title }}" id="example-text-input">
                                        @error('phone_title')
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <div id="image-preview" class="image-preview">
                                                ...
                                                <img style="width:200px" src="{{ $header?->phone_icon }}"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <div id="image-preview" class="image-preview">
                                                ...
                                                <img style="width:200px" src="{{$header?->image}}" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <div id="image-preview" class="image-preview">
                                                ...
                                                <img style="width:200px" src="{{$header?->fav_icon}}" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
