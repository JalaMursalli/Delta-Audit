            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="needs-validation" method="POST" action="{{ route('backend.footer-logo.update',1) }}"
                                ...
                                <div class="tab-content p-3 text-muted">
                                    <div class="tab-pane active" id="az">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="description_az" id="description_az" class="form-control">{!! $footer?->description_az !!}</textarea>
                                    ...
                                    <div class="tab-pane" id="en">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="description_en" id="description_en" class="form-control">{!! $footer?->description_en !!}</textarea>
                                    ...
                                    <div class="tab-pane" id="ru">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="description_ru" id="description_ru" class="form-control">{!! $footer?->description_ru !!}</textarea>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <div id="image-preview" class="image-preview">
                                                ...
                                                <img style="width:200px" src="{{$footer?->image}}" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
