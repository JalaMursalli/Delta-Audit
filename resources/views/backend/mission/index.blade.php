                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="needs-validation" method="POST" action="{{ route('backend.mission.update', 1) }}"
                                ...
                                <div class="tab-content p-3 text-muted">
                                    <div class="tab-pane active" id="az">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="title_az" type="text"
                                                    value="{{ $mission?->title_az }}" id="example-text-input">
                                                @error('title_az')
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="description_az" id="description_az" class="form-control">{!! $mission?->description_az !!}</textarea>
                                    ...
                                    <div class="tab-pane" id="en">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="title_en" type="text"
                                                    value="{{ $mission?->title_en }}" id="example-text-input">
                                                @error('title_en')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="description_en" id="description_en" class="form-control">{!! $mission?->description_en !!}</textarea>
                                    ...
                                    <div class="tab-pane" id="ru">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="title_ru" type="text"
                                                    value="{{ $mission?->title_ru }}" id="example-text-input">
                                                @error('title_ru')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="description_ru" id="description_ru" class="form-control">{!! $mission?->description_ru !!}</textarea>
                                ...
                                <div class="row mb-3 px-3">
                                    <div class="row mb-3">
                                        <label for="image-upload" class="col-sm-2 col-form-label">Şəkil (Ölçü 680x404)</label>
                                        <div class="col-sm-10">
                                            ...
                                            <div id="image-preview" class="image-preview">
                                                ...
                                                <input type="file" name="image" id="image-upload"
                                                    accept="image/*" />
                                                <img style="width:200px" src="{{ $mission?->image }}" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
