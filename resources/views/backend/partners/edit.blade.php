        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                   ...
                   <form class="needs-validation" method="POST" action="{{ route('backend.partner.update',$partner->id) }}"
                                enctype="multipart/form-data">
                                @csrf
                                @method('put')
                               <div class="row mb-3 px-3">
                                    <div class="row mb-3">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">Şəkil (Ölçü 207x83)</label>
                                        <div class="col-sm-10">
                                            <div id="image-preview" class="image-preview">
                                                <label for="image-upload" id="image-label">Faylı seç</label>
                                                <input type="file" name="image" id="image-upload" />
                                                <img style="width:200px" src="{{$partner?->image}}" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
