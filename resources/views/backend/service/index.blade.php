                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header align-items-end d-flex justify-content-between">
                           <div>
                            <h4>Xidmətlərin siyahısı</h4>
                            <div class="card-header-form">
                                <!-- Search Form -->
                                <form action="{{ route('backend.service.index') }}" method="GET" class="d-flex"
                            ...
                            <a href="{{ route('backend.service.create') }}" class="btn btn-primary">Yeni Xidmət yarat</a>
                        </div>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    @forelse ($services as $key => $service)
                                        <tr>
                                            <td>{{ $services->firstItem() + $key }}</td> <!-- Keeps count on pagination -->
                                            <td>
                                            ...
                                            <td class="text-end">
                                                <div class="d-flex justify-content-end " style="gap: 20px">
                                                    ...
                                                    <form
                                                        action="{{ route('backend.service.destroy', $service?->id ?? '') }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="3" class="text-center">Xidmət tapılmadı</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
