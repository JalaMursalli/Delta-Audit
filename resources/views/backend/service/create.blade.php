                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="needs-validation" method="POST" action="{{ route('backend.service.store') }}"
                                ...
                                <div class="tab-content p-3 text-muted">
                                    <div class="tab-pane active" id="az">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="title_az" type="text"
                                                    value="{{ $service?->title_az }}" id="example-text-input">
                                                @error('title_az')
                                        ...
                                        <div class="row mb-3">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Qısa Mətn (Az)
                                            </label>
                                            <div class="col-sm-10">
                                    ...
                                    <div class="tab-pane" id="en">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="title_en" type="text"
                                                    value="{{ $service?->title_en }}" id="example-text-input">
                                                @error('title_en')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Qısa Mətn (En)
                                            </label>
                                            <div class="col-sm-10">
                                    ...
                                    <div class="tab-pane" id="ru">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="title_ru" type="text"
                                                    value="{{ $service?->title_ru }}" id="example-text-input">
                                                @error('title_ru')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Qısa Mətn (Ru)
                                            </label>
                                            <div class="col-sm-10">
                                                <textarea name="short_description_ru" id="short_description_ru" class="form-control">{!! $service->short_description_ru !!}</textarea>
                                                @error('short_description1_ru')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                                @enderror
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="description_ru" id="description_ru" class="summernote">{!! $service->description_ru !!}</textarea>
