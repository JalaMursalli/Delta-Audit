                    ...
                    <div class="text-center mt-4">
                        <div class="mb-3">
                            <a href="index.html" class="auth-logo">
                                <img src="{{asset('backend/assets/images/ce5ed9cf492eed1b09653b58d167365a.png')}}" height="100" class="logo-dark mx-auto" alt="">
                                <img src="{{asset('backend/assets/images/ce5ed9cf492eed1b09653b58d167365a.png')}}" height="100" class="logo-light mx-auto" alt="">
                            </a>
                        </div>
                    </div>
