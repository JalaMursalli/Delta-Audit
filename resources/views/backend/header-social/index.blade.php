                    ...
                    <div class="card">
                        <div class="card-header align-items-end d-flex justify-content-between">
                           <div>
                            ...
                            <a href="{{ route('backend.header-social.create') }}" class="btn btn-primary">Yeni Sosial Şəbəkə yarat</a>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <div class="d-flex justify-content-end " style="gap: 20px">
                                                    <a href="{{ route('backend.header-social.edit', $social?->id ?? '') }}"
                                                        class="btn btn-warning btn-sm">
                                                        <i class="fas fa-edit"></i> Edit
                                                    </a>

                                                    <form
                                                        action="{{ route('backend.header-social.destroy', $social?->id ?? '') }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
